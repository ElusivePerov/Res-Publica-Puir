...
country = {
	...
	RESEARCH_POINTS_ON_CONQUER_MULT = 198, -- multiplier to RP got by conquering as unciv when got enacted military reforms
...
diplomacy = {
	...
	PRESTIGE_REDUCTION = 0.15, -- Base value + % of recipient's prestige
	REPARATIONS_YEARS = 2,
	...
	PEACE_COST_GUNBOAT = 2000, -- Cost of forcing a defaulting country to pay its debt
